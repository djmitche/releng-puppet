...
<<<<<<< Updated upstream
                    # note that this DMG might work on 10.8, too.  At least some parts work on 10.9, but
                    # packageMaker does not (use packages::packagemaker instead)
=======
                    # note that this DMG might work on 10.8, too.  It does *not* work on 10.9.
>>>>>>> Stashed changes
                    packages::pkgdmg {
                        "xcode":
                            version => "4.1",
